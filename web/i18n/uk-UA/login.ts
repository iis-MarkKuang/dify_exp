const translation = {
  ...
  welcome: 'Ласкаво просимо до Microcraft, будь ласка, увійдіть, щоб продовжити.',
  ...
  license: {
    tip: 'Перед запуском Microcraft Community Edition ознайомтеся з ліцензією з відкритим кодом на GitHub',
    link: 'Ліцензія з відкритим кодом',
  },
  join: 'Приєднуйтесь',
  joinTipStart: 'Запрошуємо вас приєднатися',
  joinTipEnd: 'команда Microcraft',
  invalid: 'Посилання застаріло',
  explore: 'Досліджуйте Microcraft',
