const translation = {
  ...
  apiKeyInfo: {
    ...
    tryCloud: 'Sau încercați versiunea cloud a Microcraft cu cotă gratuită',
  },
  overview: {
    ...
    appInfo: {
      ...
      settings: {
        ...
        more: {
          ...
          privacyPolicyTip: 'Ajută vizitatorii să înțeleagă datele pe care le colectează aplicația, consultați <privacyPolicyLink>Politica de confidențialitate</privacyPolicyLink> a Microcraft.',
        },
      },
      embedded: {
        entry: 'Încorporat',
        ...
        chromePlugin: 'Instalați extensia Chrome Microcraft Chatbot',
        copied: 'Copiat',
        copy: 'Copiați',
      },
      qrcode: {
