const translation = {
  ...
  welcome: 'Bine ai venit la Microcraft, te rugăm să te autentifici pentru a continua.',
  ...
  license: {
    tip: 'Înainte de a începe Microcraft Community Edition, citește',
    link: 'Licența open-source de pe GitHub',
  },
  join: 'Alătură-te',
  joinTipStart: 'Te invităm să te alături echipei',
  joinTipEnd: 'pe Microcraft',
  invalid: 'Link-ul a expirat',
  explore: 'Explorează Microcraft',
