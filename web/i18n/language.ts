...
export const NOTICE_I18N = {
  ...
  desc: {
    ...
    zh_Hans: '为了有效提升数据检索能力及稳定性，Microcraft 将于 2023 年 8 月 29 日 03:00 至 08:00 期间进行服务升级，届时 Microcraft 云端版及应用将无法访问。感谢您的耐心与支持。',
