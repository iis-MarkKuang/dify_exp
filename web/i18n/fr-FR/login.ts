const translation = {
  ...
  welcome: 'Bienvenue sur Microcraft, veuillez vous connecter pour continuer.',
  ...
  license: {
    tip: 'Avant de commencer Microcraft Community Edition, lisez le GitHub',
    link: 'Licence Open-source',
  },
  join: 'Rejoindre',
  joinTipStart: 'Je vous invite à rejoindre',
  joinTipEnd: 'équipe sur Microcraft',
  invalid: 'Le lien a expiré',
  explore: 'Explorez Microcraft',
