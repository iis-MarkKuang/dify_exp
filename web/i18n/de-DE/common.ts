const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Microcraft-Konto',
    langGeniusAccountTip: 'Ihr Microcraft-Konto und zugehörige Benutzerdaten.',
  ...
  members: {
    ...
    invitationSentTip: 'Einladung gesendet, und sie können sich bei Microcraft anmelden, um auf Ihre Teamdaten zuzugreifen.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'Der OpenAI-Hostingdienst von Microcraft ermöglicht es Ihnen, Modelle wie GPT-3.5 zu verwenden. Bevor Ihr Probe-Kontingent aufgebraucht ist, müssen Sie andere Modellanbieter einrichten.',
  ...
  apiBasedExtension: {
    title: 'API-Erweiterungen bieten zentralisiertes API-Management und vereinfachen die Konfiguration für eine einfache Verwendung in Microcrafts Anwendungen.',
  ...
  about: {
    ...
    nowAvailable: 'Microcraft {{version}} ist jetzt verfügbar.',
    latestAvailable: 'Microcraft {{version}} ist die neueste verfügbare Version.',
  },
  appMenus: {
    overview: 'Übersicht',
