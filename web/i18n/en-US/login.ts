const translation = {
  ...
  welcome: 'welcome to Microcraft, please log in to continue.',
  email: 'Email address',
  ...
  license: {
    tip: 'Before starting Microcraft Community Edition, read the GitHub',
    link: 'Open-source License',
  },
  join: 'Join',
  joinTipStart: 'Invite you join',
  joinTipEnd: 'team on Microcraft',
  invalid: 'The link has expired',
  explore: 'Explore Microcraft',
