const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Microcraft account',
    langGeniusAccountTip: 'Your Microcraft account and associated user data.',
    editName: 'Edit Name',
  ...
  members: {
    ...
    invitationSentTip: 'Invitation sent, and they can sign in to Microcraft to access your team data.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'The OpenAI hosting service provided by Microcraft allows you to use models such as GPT-3.5. Before your trial quota is used up, you need to set up other model providers.',
  ...
  apiBasedExtension: {
    title: 'API extensions provide centralized API management, simplifying configuration for easy use across Microcraft\'s applications.',
  ...
  about: {
    ...
    nowAvailable: 'Microcraft {{version}} is now available.',
    latestAvailable: 'Microcraft {{version}} is the latest version available.',
  },
  appMenus: {
    overview: 'Overview',
