const translation = {
  ...
  welcome: 'Bem-vindo ao Microcraft, faça login para continuar.',
  ...
  license: {
    tip: 'Antes de começar a usar a Edição Comunitária do Microcraft, leia a',
    link: 'Licença de código aberto do GitHub',
  },
  join: 'Participar',
  joinTipStart: 'Convidamos você a participar da',
  joinTipEnd: 'equipe no Microcraft',
  invalid: 'O link expirou',
  explore: 'Explorar o Microcraft',
