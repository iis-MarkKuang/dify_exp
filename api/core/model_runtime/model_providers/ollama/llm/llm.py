        ...
        for chunk in response.iter_lines(decode_unicode=True, delimiter="\n"):
            ...
            try:
                ...
                yield create_final_llm_result_chunk(
                    index=chunk_index, message=AssistantPromptMessage(content=""), finish_reason="Non-JSON encountered."
                )
            ...
            if chunk_json["done"]:
                ...
                yield LLMResultChunk(
                    ...
                    delta=LLMResultChunkDelta(
                        index=chunk_index, message=assistant_prompt_message, finish_reason="stop", usage=usage
                    ),
                )
            else:
                yield LLMResultChunk(
