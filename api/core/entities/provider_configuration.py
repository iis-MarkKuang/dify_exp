...
class ProviderConfiguration(BaseModel):
    ...
    def custom_credentials_validate(self, credentials: dict) -> tuple[Provider, dict]:
        ...
        credentials = model_provider_factory.provider_credentials_validate(self.provider.provider, credentials)
    ...
    def _obfuscated_credentials(self, credentials: dict, credential_form_schemas: list[CredentialFormSchema]) -> dict:
        ...
        """
        # Get provider credential secret variables
        credential_secret_variables = self._extract_secret_variables(credential_form_schemas)
