    ...
    def _init_vector(self) -> BaseVector:
        ...
        if vector_type == "weaviate":
            ...
            if self._dataset.index_struct_dict:
                ...
                index_struct_dict = {"type": "weaviate", "vector_store": {"class_prefix": collection_name}}
            ...
            if not self._dataset.index_struct_dict:
                index_struct_dict = {"type": "qdrant", "vector_store": {"class_prefix": collection_name}}
                self._dataset.index_struct = json.dumps(index_struct_dict)
            ...
            if self._dataset.index_struct_dict:
                ...
                dataset_id = self._dataset.id
                collection_name = Dataset.gen_collection_name_by_id(dataset_id)
                index_struct_dict = {"type": "milvus", "vector_store": {"class_prefix": collection_name}}
                self._dataset.index_struct = json.dumps(index_struct_dict)
            return MilvusVector(
                collection_name=collection_name,
                config=MilvusConfig(
            ...
            if self._dataset.index_struct_dict:
                ...
                index_struct_dict = {"type": "pgvecto_rs", "vector_store": {"class_prefix": collection_name}}
                self._dataset.index_struct = json.dumps(index_struct_dict)
            ...
            if self._dataset.index_struct_dict:
                ...
                dataset_id = self._dataset.id
                collection_name = Dataset.gen_collection_name_by_id(dataset_id)
                index_struct_dict = {"type": "pgvector", "vector_store": {"class_prefix": collection_name}}
                self._dataset.index_struct = json.dumps(index_struct_dict)
            return PGVector(
                collection_name=collection_name,
