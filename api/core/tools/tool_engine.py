...
class ToolEngine:
    ...
    def agent_invoke(
        ...
        try:
            ...
            agent_tool_callback.on_tool_end(
                tool_name=tool.identity.name, tool_inputs=tool_parameters, tool_outputs=plain_text
            )
    ...
    def workflow_invoke(
        ...
        try:
            ...
            workflow_tool_callback.on_tool_end(
                tool_name=tool.identity.name, tool_inputs=tool_parameters, tool_outputs=response
            )
    ...
    def _create_message_files(
        ...
        for message in tool_messages:
            ...
            result.append((message_file, message.save_as))
