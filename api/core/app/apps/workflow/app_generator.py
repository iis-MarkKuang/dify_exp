...
class WorkflowAppGenerator(BaseAppGenerator):
    ...
    def _generate_worker(
        self, flask_app: Flask, application_generate_entity: WorkflowAppGenerateEntity, queue_manager: AppQueueManager
    ) -> None:
        """
        ...
        with flask_app.app_context():
            try:
                ...
                if application_generate_entity.single_iteration_run:
                    ...
                    runner.run(application_generate_entity=application_generate_entity, queue_manager=queue_manager)
