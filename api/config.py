...
class Config:
    ...
    def __init__(self):
        ...
        # cors settings
        self.CONSOLE_CORS_ALLOW_ORIGINS = get_cors_allow_origins("CONSOLE_CORS_ALLOW_ORIGINS", self.CONSOLE_WEB_URL)
        self.WEB_API_CORS_ALLOW_ORIGINS = get_cors_allow_origins("WEB_API_CORS_ALLOW_ORIGINS", "*")
        ...
        db_credentials = {
            key: get_env(key)
            for key in ["DB_USERNAME", "DB_PASSWORD", "DB_HOST", "DB_PORT", "DB_DATABASE", "DB_CHARSET"]
        }
