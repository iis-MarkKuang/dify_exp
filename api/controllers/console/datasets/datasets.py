...
class DatasetApi(Resource):
    ...
    def patch(self, dataset_id):
        ...
        parser.add_argument(
            "permission", type=str, location="json", choices=("only_me", "all_team_members"), help="Invalid permission."
        )
...
class DatasetApiBaseUrlApi(Resource):
    ...
    def get(self):
        return {
            "api_base_url": (
                current_app.config["SERVICE_API_URL"]
                if current_app.config["SERVICE_API_URL"]
...
class DatasetRetrievalSettingApi(Resource):
    ...
    def get(self):
        ...
        if vector_type in {"milvus", "relyt", "pgvector", "pgvecto_rs"}:
            return {"retrieval_method": ["semantic_search"]}
        elif vector_type in {"qdrant", "weaviate"}:
            return {"retrieval_method": ["semantic_search", "full_text_search", "hybrid_search"]}
        else:
