...
class DataSourceApi(Resource):
    ...
    def get(self):
        ...
        data_source_integrates = (
            db.session.query(DataSourceBinding)
            .filter(DataSourceBinding.tenant_id == current_user.current_tenant_id, DataSourceBinding.disabled == False)
            .all()
        )
    ...
    def patch(self, binding_id, action):
        ...
        action = str(action)
        data_source_binding = DataSourceBinding.query.filter_by(id=binding_id).first()
