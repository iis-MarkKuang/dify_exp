...
def default_variables():
    return [
        VariableEntity(variable="text_input", label="text-input", type=VariableEntity.Type.TEXT_INPUT),
        VariableEntity(variable="paragraph", label="paragraph", type=VariableEntity.Type.PARAGRAPH),
        VariableEntity(variable="select", label="select", type=VariableEntity.Type.SELECT),
    ]
