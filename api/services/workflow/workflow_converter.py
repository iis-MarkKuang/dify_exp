...
class WorkflowConverter:
    ...
    def convert_to_workflow(self, app_model: App, account: Account, name: str, icon: str, icon_background: str) -> App:
        """
        ...
        for external_data_variable in external_data_variables:
            ...
            if not api_based_extension:
                raise ValueError(
                    ...
                    "error: api_based_extension_id is invalid".format(tool_variable)
                )
        ...
        # Completion Model
            ...
            if prompt_template.prompt_type == PromptTemplateEntity.PromptType.SIMPLE:
                ...
                role_prefix = {
                    ...
                    "assistant": prompt_rules["assistant_prefix"]
                    if "assistant_prefix" in prompt_rules
                    else "Assistant",
                }
            else:
        ...
        return {
            ...
            "data": {
                ...
                "vision": {
                    ...
                    "configs": {"detail": file_upload.image_config["detail"]} if file_upload is not None else None,
                },
            },
        }
